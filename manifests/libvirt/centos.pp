...
class virt::libvirt::centos inherits virt::libvirt::base {
  file{'/etc/sysconfig/libvirt-guests':
    source  => [
      ...
      "puppet:///modules/site_virt/libvirt/configs/${::operatingsystem}/${::operatingsystemmajrelease}/libvirt-guests",
      ...
      "puppet:///modules/virt/libvirt/configs/${::operatingsystem}/${::operatingsystemmajrelease}/libvirt-guests",
